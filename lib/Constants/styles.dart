...
TextStyle headingTextStyle=TextStyle(color: blackColor,fontSize: 25,fontWeight: FontWeight.bold);
TextStyle subHeadingTextStyle=TextStyle(color: blackColor,fontSize: 20,fontWeight: FontWeight.normal);
